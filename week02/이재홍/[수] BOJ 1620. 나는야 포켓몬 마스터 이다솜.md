...
- 시간 초과: 해시테이블을 만들 때에 사이즈는 크기가 큰 소수로 해야 한다. 해시코드도 그냥 나머지를 활용하는 것이 아니라, 복잡한 로직이 필요하다.



![3](https://github.com/compasstar/algo-study/assets/55419868/8b8ac599-b3e6-42e9-93fb-53f94f379fb8)
